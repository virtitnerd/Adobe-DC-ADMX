"""
Produce minified copies of ADMX/AdobeDC.admx and ADMX/en-US/AdobeDC.adml for
...
The source files in ADMX/ are left exactly as they are -- this only writes
new minified files for the release packaging step.
